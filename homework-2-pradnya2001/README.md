...
The goal of this homework is to teach you some basic grammar and functionalities contained in D3.js:
...
The starter codes for this semester will be given with D3.v7. **You should use D3.v7 in your homeworks and project.**

>❗️ The sharing and copying code with other students is considering cheating, as is using ChatGPT, Coding co-pilots, or other generative AI. Passing off (part of) a codebase from someone else (including from a previous semester) as your own is also plagiarism.
...
* Add your name and email where appropriate in index.html file.
